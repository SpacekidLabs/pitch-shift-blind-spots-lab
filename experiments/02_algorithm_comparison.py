...
from visualization.comparison_heatmap import save_algorithm_comparison_heatmap
...
def run_experiment() -> pd.DataFrame:
    ...
    save_algorithm_comparison_heatmap(results, artifacts_dir / "02_heatmap.png")
    return results


def main() -> None:
    results = run_experiment()
    print(f"Wrote {len(results)} rows to artifacts/02_results.csv")
    print("Wrote artifacts/02_heatmap.png")
    print("Question: Do these algorithms fail on the same structures?")
